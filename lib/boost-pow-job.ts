...
export class BoostPowJobModel {
    ...
    private getNumberHexBuffer(v: any, length: number): any {
        return BoostPowJob.createBufferAndPad(v.toString(16).padStart(2, '0'), length);
    }
