...
describe('boost #BoostPowJob create various getters and setters',
         () => {
           it('should be valid minimal', async () => {
             let content =
                 Buffer.from('hello world', 'ascii').reverse().toString('hex');
           ...
           it('should decode multiple Boost outputs test_decode', async () => {
             const jobs = index.BoostPowJob.fromTransactionGetAllOutputs(
                 new bsv.Transaction(
                     ''));
           ...
           it('should generate same formatted bits as bitcoin block 0000000000002917ed80650c6174aac8dfc46f5fe36480aaef682ff6cd83c3ca',
              async () => {
                const job = index.BoostPowJob.fromObject({
                  content :
           ...
           it('should return error for too large and invalid values. content',
              async () => {
                try {
                  ...
                  expect(ex.toString())
                      .to.equal('Error: content too large. Max 32 bytes.');
                  return;
                }
                expect(true).to.eql(false);
              });

           it('should return error for too large and invalid values. diff',
              async () => {
                try {
                  index.BoostPowJob.fromObject({
                    content :
           ...
           it('should return error for too large and invalid values. category',
              async () => {
                try {
                  index.BoostPowJob.fromObject({
                    content :
                  ...
                  expect(ex.toString())
                      .to.equal('Error: category too large. Max 4 bytes.');
                  return;
                }
                expect(true).to.eql(false);
              });

           it('should return error for too large and invalid values. tag',
              async () => {
                try {
                  index.BoostPowJob.fromObject({
                    content :
                  ...
                  expect(ex.toString())
                      .to.equal('Error: tag too large. Max 20 bytes.');
                  return;
                }
                expect(true).to.eql(false);
              });

           it('should return error for too large and invalid values. userNonce',
              async () => {
                try {
                  index.BoostPowJob.fromObject({
                    content :
                  ...
                  expect(ex.toString())
                      .to.equal('Error: userNonce too large. Max 4 bytes.');
                  return;
                }
                expect(true).to.eql(false);
              });
...
describe('boost #BoostPowString tryValidateJobProof', () => {
  it('tryValidateJobProof success sample test_decode', async () => {
    ...
    expect(result.boostPowString.toString())
        .to.eql(
    ...
    expect(jobProof.txid)
        .to.eql(
            '6f1060446ad5cf56d2cf75c116be3b6b354cf0c7b3e8da57fb3a9d6b71780ad0');
    expect(jobObj.time).to.eql('b7768f5f');
    expect(index.BoostSignal
               .fromHex(result.boostPowString.toString(),
                        result.boostPowMetadata.toString())
               .time())
        .to.eql(1603237559);
    expect(result.boostPowString.metadataHash())
        .to.eql(result.boostPowMetadata.hash());
  });
  ...
  it('tryValidateJobProof success valid pow mined', async () => {
    ...
    */
    const jobProof = index.BoostPowJobProof.fromObject({
      ...
      minerPubKeyHash :
          Buffer.from('9fb8cb68b8850a13c7438e26e1d277b748be657a', 'hex')
              .toString('hex'),
    });
    const result = index.BoostPowJob.tryValidateJobProof(job, jobProof, false);
    expect(result.boostPowString.hash())
...
describe('boost #BoostPowJob createRedeemTransaction', () => {
  it('createRedeemTransaction success', async () => {
    ...
    */
    ...
    expect(powString.boostPowString.toString())
        .to.eql(
    ...
    expect(powString.boostPowString.hash())
        .to.eql(
            '0000000000f0e97bec0c369dd6c7cbde0243a351d8ab138778717c63660afa35');
...
describe('BoostPowJob', () => {
  it('should correctly set txid if provided from all loaders', async () => {
    ...
    job = index.BoostPowJob.fromASM(
        job.toASM(),
        '32617d4a0477a15cabf65e3731c8cf604861956826bdf3338e346c7dacdd5a5c', 2,
        3432);
    expect(job.getTxOutpoint()).to.eql({
  ...
  it('should correctly get paramters', async () => {
    let data =
        index.BoostUtilsHelper.stringToBuffer('this is more additionalData', 32)
            .toString('hex');
    const job = index.BoostPowJob.fromObject({
      ...
      diff : 21,
      category :
          index.BoostUtilsHelper.stringToBuffer('bill', 4).toString('hex'),
  ...
  it('should correctly match up forms of variables for pow string and pow job',
     async () => {
  ...
  it('should correctly match target and bits for known bitcoin header 0000000000002917ed80650c6174aac8dfc46f5fe36480aaef682ff6cd83c3ca',
     async () => {
       const job = index.BoostPowJob.fromHex(
           index.BoostPowJob
               .fromASM(
       ...
       expect(index.BoostPowJob.hexBitsToDifficulty('1a6a93b3'))
           .to.eql(157416.40184364);
     });
  ...
  it('check to string and from string', async () => {
    const job = index.BoostPowJob.fromObject({
      ...
      tag : index.BoostUtilsHelper.stringToBuffer('gat a si siht', 20)
                .reverse()
                .toString('hex'),
      additionalData : index.BoostUtilsHelper
                           .stringToBuffer('ataDlanoitidda erom si siht', 64)
                           .reverse()
                           .toString('hex'),
  ...
  it('should handle additional data correctly', async () => {
    expect(() => {
      const correctJob = index.BoostPowJob.fromObject({
        ...
        diff : 21.00002253,
        category :
            index.BoostUtilsHelper.stringToBuffer('bill', 4).reverse().toString(
                'hex'),
        tag : index.BoostUtilsHelper.stringToBuffer('this is a tag', 20)
                  .reverse()
                  .toString('hex'),
        additionalData :
            index.BoostUtilsHelper
                .stringToBuffer('this is more additionalData', 65535)
                .reverse()
                .toString('hex'),
        userNonce : index.BoostUtilsHelper.createBufferAndPad('01c8', 4)
                        .reverse()
    ...
    expect(() => {
      const correctJob = index.BoostPowJob.fromObject({
        ...
        tag : index.BoostUtilsHelper.stringToBuffer('this is a tag', 20)
                  ...
                  .toString('hex'),
        additionalData :
            index.BoostUtilsHelper.stringToBuffer('', 0).reverse().toString(
                'hex'),
        userNonce : index.BoostUtilsHelper.createBufferAndPad('01c8', 4)
                        .reverse()
                        .toString('hex')
    ...
    expect(() => {
      const correctJob = index.BoostPowJob.fromObject({
        ...
        tag : index.BoostUtilsHelper.stringToBuffer('this is a tag', 20)
                  ...
                  .toString('hex'),
        additionalData : index.BoostUtilsHelper
                             .stringToBuffer('this is more additional data', 33)
                             .reverse()
                             .toString('hex'),
        userNonce : index.BoostUtilsHelper.createBufferAndPad('01c8', 4)
                        .reverse()
    ...
    expect(() => {
      const correctJob = index.BoostPowJob.fromObject({
        ...
        tag : index.BoostUtilsHelper.stringToBuffer('this is a tag', 20)
                  ...
                  .toString('hex'),
        additionalData : index.BoostUtilsHelper
                             .stringToBuffer('this is more additionalData', 32)
                             .reverse()
                             .toString('hex'),
        userNonce : index.BoostUtilsHelper.createBufferAndPad('01c8', 4)
                        .reverse()
    ...
    expect(() => {
      const zeroTag = index.BoostPowJob.fromObject({
        ...
        category :
            index.BoostUtilsHelper.stringToBuffer('bill', 4).reverse().toString(
                'hex'),
        tag : index.BoostUtilsHelper.stringToBuffer('', 0).reverse().toString(
            'hex'),
        additionalData : index.BoostUtilsHelper
                             .stringToBuffer('this is more additionalData', 32)
                             .reverse()
  ...
  it('should correctly get content for capitalists', async () => {
    ...
    const job = index.BoostPowJob.fromObject({
      content :
          index.BoostUtilsHelper.createBufferAndPad(hashed, 32).toString('hex'),
      diff : 21,
      category :
          index.BoostUtilsHelper.stringToBuffer('bill', 4).reverse().toString(
              'hex'),
...
describe('Convert difficulty to bits and back', () => {
  ...
  it('difficulty = ten thousandth', () => {
    ...
    expect(index.BoostUtilsHelper.difficulty2bits(
