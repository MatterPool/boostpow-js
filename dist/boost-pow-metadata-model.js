...
class BoostPowMetadataModel {
  ...
  static fromObject(params) {
    return new BoostPowMetadataModel(
        ...
        boost_utils_1.BoostUtils.createBufferAndPad(params.minerPubKeyHash, 20,
                                                    false),
  ...
  getAdditionalDataUtf8() {
    return this.trimBufferString(
        Buffer.from(this.additionalData).toString('hex'), true);
  }
  ...
  hashAsBuffer() { return bsv.crypto.Hash.sha256sha256(this.toBuffer()); }
  toObject() {
    return {
