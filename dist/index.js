...
exports.getJobStatus = exports.submitJob = exports.rawSearch =
    exports.BoostPowSimpleMiner = exports.BoostSignalRanker =
        exports.BoostSignal = exports.BoostGraph = exports.BoostUtilsHelper =
            exports.BoostPowMetadata = exports.BoostPowJobProof =
                exports.BoostPowJob = exports.BoostPowString =
                    exports.instance = exports.Graph =
                        exports.BoostGraphClient = void 0;
...
const boost_pow_simple_miner_model_1 =
    require("./boost-pow-simple-miner-model");
...
class BoostGraphClient {
  ...
  get BoostPowString() { return boost_pow_string_model_1.BoostPowStringModel; }
  get BoostPowJob() { return boost_pow_job_model_1.BoostPowJobModel; }
  ...
  get BoostPowSignal() { return boost_signal_model_1.BoostSignalModel; }
  get BoostUtilsHelper() { return exports.BoostUtilsHelper; }
  rawSearch(q, callback) {
    const apiClient =
        new boost_graph_api_client_1.BoostGraphApiClient(this.options);
...
exports.BoostPowSimpleMiner =
    boost_pow_simple_miner_model_1.BoostPowSimpleMinerModel;
function rawSearchGraph(q, callback) {
  const apiClient =
      new boost_graph_api_client_1.BoostGraphApiClient(defaultOptions);
  return apiClient.rawSearch(q, callback);
}
