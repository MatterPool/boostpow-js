...
class BoostPowStringModel {
   ...
   *
   * If even a single entry is not valid, then an exception will be thrown and
   * parsing of everything fails.
   *
   * Initially we can be strict because we should expect careful usage and
   * passing of data.
   *
   * @param arrayOfPotentialBoostPowStrings Array of objects that have
   *     toString() defined
   */
