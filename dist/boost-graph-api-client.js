...
class BoostGraphApiClient {
  ...
  broadcastBoostJobProof(tx, callback) {
    return new Promise((resolve, reject) => {
      ...
      axios_1.default
        .post(
          this.fullUrl + `/merchants/tx/broadcast`,
          { rawtx: boostJobProof },
  ...
  submitBoostJob(rawtx, callback) {
    return new Promise((resolve, reject) => {
      axios_1.default
        .post(
          this.options.graph_api_url + `/api/v1/main/boost/jobs`,
          {
            rawtx: rawtx,
          },
          { headers: this.getHeaders() }
  ...
  submitBatchBoostJobRequest(rawtx, params, callback) {
    return new Promise((resolve, reject) => {
      axios_1.default
        .post(
          this.options.graph_api_url + `/api/v1/main/service/pay`,
  ...
  submitBoostSolution(params, callback) {
    return new Promise((resolve, reject) => {
      axios_1.default
        .post(
          this.options.graph_api_url + `/api/v1/main/boost/submitsolution`,
          {
            txid: params.txid,
            vout: params.vout,
            nonce: params.nonce,
  ...
  rawSearch(q, callback) {
    return new Promise((resolve, reject) => {
      ...
      axios_1.default
        .get(
          this.options.graph_api_url + `/api/v1/main/boost/search${qString}`,
          { headers: this.getHeaders() }
        )
        .then((response) => {
          const queryResponse =
  ...
  loadBoostJob(txid, callback) {
    return new Promise((resolve, reject) => {
      ...
      axios_1.default
        ...
        .then((response) => {
          const jobs =
            boost_pow_job_model_1.BoostPowJobModel.fromTransactionGetAllOutputs(
              response.data.rawtx
            );
          if (!jobs || !jobs.length) {
            return this.rejectOrCallback(
